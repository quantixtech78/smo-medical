...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] shadow-soft flex items-center justify-center hover:scale-110 transition-transform"
    >
      <svg
